"""exp009: the same ten-minute physical mode model, without switch cap or wear objective.
...
def plan(net_paths, price, soc, previous_mode=1, previous_run_slots=1,
         *, hold_slots=1, switching=0., wear=0., seconds=5., gap=.002, final=False):
    ...
    metadata.update(method='exp009_variable_hold1_no_cap_no_intensity_physical_scenario_MIP',
        daily_planned_switch_cap=None, switching_cost=0., exact_binary_XOR=True,
