"""Predeclared HGB/hold1 hard cap8 switching budget; no soft switch penalty."""
...
OUT = ROOT/'data/results/exp008/mode_budget_hold1_physical/direct_hgb_memory_hold1_cap8_kappa0_334days'
HOLD3 = ROOT/'data/results/exp008/mode_budget_physical/direct_hgb_memory_hold3_cap8_kappa0_334days'
...
def prepare(forecast):
    ...
    protocol = {'evaluation_days': 334, 'candidate_count': 1, 'pipeline': PRIMARY,
        ...
        'change_from_hold3': 'minimum planned mode hold3 relaxed to hold1; initial two-slot lock removed',
    ...
    names = sorted({path for relative in ('experiments/exp008', 'experiments/common/neural_v2',
                    ...
                    'experiments/problem2/tree_planning')
...
def run():
    from experiments.exp008.hgb_mode_budget_hold1_audit import audit
