"""Predeclared HGB/hold3 hard cap8 switching budget; no soft switch penalty."""
...
from experiments.exp008.mode_budget_physical import plan
...
OUT = ROOT/'data/results/exp008/mode_budget_physical/direct_hgb_memory_hold3_cap8_kappa0_334days'
...
def run():
    from experiments.exp008.hgb_mode_budget_audit import audit
