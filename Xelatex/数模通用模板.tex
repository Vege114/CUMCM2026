...
\end{equation}
\begin{equation}
 1200\,kWh\leq E_t\leq10800\,kWh\quad,
 \qquad E_1=E_{T+1}=6000\,kWh.
 \label{eq:q1-boundary}
\end{equation}

其中，$E_t$与$E_{t+1}$分别为区间$t$开始和结束时电池内部的储电量，单位为kWh；$\eta_c$与$\eta_d$分别为充电效率和放电效率，$\eta_{\rm rt}=\eta_c\eta_d$为往返效率。
