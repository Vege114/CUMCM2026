...
\begin{table}[htbp]
 ...
 \end{tabular}
\end{table}
平稳方案总变差下降67.6589\%，启动次数减少66.6667\%，代价是购电费增加313.536809元，即0.9276\%。该代价包含两部分：
\begin{equation}
...
相比之下，往返效率降至81\%时费用增加约3.9735\%，升至99\%时费用下降约3.56897\%，且后者启动次数增至6。效率影响单位放电的购入成本，还会改变有利套利时段和模式选择。因此只能认为本轮方案对费用预算及爬坡参数的局部扰动较稳定，不能据此声称对全部参数均不敏感。各情景的独立约束违反项均为0。

\subsubsection{输入噪声与固定计划压力测试}
在缺乏实测误差分布的条件下，设置小幅、可重复的数值扰动，检验模型对输入变化的反应：
\begin{equation}
 \widetilde L_t=L_t(1+\zeta_t^L),\quad
 \widetilde V_t=V_t(1+\zeta_t^V),\qquad
 \zeta_t^j=\operatorname{clip}(Z_t^j,-0.03,0.03),\
...
\section{问题二的模型建立与求解}\label{sec:q2-exp006}
...
\toprule 时间段 & 购电量 & 时间段 & 购电量 & 时间段 & 购电量\\
\midrule
...
\toprule 时间段 & 充电量 & 放电量 & 时间段 & 充电量 & 放电量\\
\midrule
0:00--4:00 & 7897.4715 & 0.0000 & 4:00--8:00 & 2371.7082 & 5828.0182\\
8:00--12:00 & 5533.9859 & 2670.2740 & 12:00--16:00 & 3488.0821 & 246.2828\\
...
\toprule 时间段 & 充电量 & 放电量 & 时间段 & 充电量 & 放电量\\
\midrule
0:00--4:00 & 7908.8883 & 0.0000 & 4:00--8:00 & 1633.8435 & 6404.9719\\
8:00--12:00 & 4825.9760 & 1792.3856 & 12:00--16:00 & 4575.4004 & 327.0221\\
...
\toprule 指标 & 同预测基础调度 & 正式主组 & 旧执行重规划对照\\
\midrule
