"""Re-run accepted Q2/Q4-2 policies continuously from 2025-01-01, SOC 6000.

Run a three-day vertical slice, obtain independent P1 review, then resume the
same directory through all 365 days. Daily chunks preserve all boundary states.
"""
import argparse
import hashlib
import json
